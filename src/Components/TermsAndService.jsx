...
const TermsOfService = () => {
    ...
    return (
        <div className="bg-gray-900 text-gray-200 p-8">
            ...
            <p className="mb-4">
                These Terms of Service ("Terms") govern your use of Crushers
                (the "App"). By accessing or using the App, you agree to comply
                with these Terms.
            </p>
            ...
            <p className="mb-4">
                By using the App, you acknowledge and agree to these Terms. If
            ...
            <p className="mb-4">
                You agree to use the App for lawful purposes and in compliance
                with all applicable laws and regulations. You further agree not
                to engage in any activity that may interfere with the proper
            ...
            <p className="mb-4">
                The App may allow users to submit, post, or share content. By
                doing so, you grant Crushers a worldwide, non-exclusive,
            ...
            <p className="mb-4">
                Crushers reserves the right to terminate or suspend your access
                to the App at any time, with or without cause. Upon termination,
                your rights to use the App will cease immediately.
            </p>

            <h2 className="text-2xl font-bold mb-2">6. Changes to Terms</h2>

            <p className="mb-4">
                Crushers may update these Terms at any time. It is your
