    ...
    <div className="w-full py-2 min-h-[10vh] bg-black sticky top-0 z-20">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex relative grow md:justify-end justify-center">
          <input
            className="flex h-11 md:w-[400px] w-[270px] rounded-md bg-gray-200 px-3 py-2 placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-white/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 text-lg"
            type="text"
            placeholder="Search"
                  ...
                  <nav className="grid gap-y-4">
                    {menuItems.map((item) => (
                      <Link
                        ...
                        key={item.name}
                        to={item.href}
                        className="-m-3 flex items-center rounded-md p-3 text-sm text-white font-semibold hover:bg-gray-500"
                      >
